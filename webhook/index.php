...
/**
 * Busca el cliente por cédula, genera el PDF del certificado
 * y lo envía por WhatsApp con la URL temporal.
 * Retorna [texto, pdfUrl|null] para que el llamador use wsSend().
 */
function generarCertificado($doc, $telefono) {
    try {
        ...
        $texto =
            "🏅 *¡Aquí está tu Certificado de Inscripción!*\n\n" .
            "👤 *{$nombre}*\n\n" .
